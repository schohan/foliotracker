...
root_agent = Agent(
    ...
    instruction=(
        ...
        "If status is error: explain error_message in plain language (do not "
        "dump exception class names). State whether evidence is still present. "
        "If error_code starts with THESIS_, clarify that market/news evidence "
        "may have been gathered but a cited thesis could not be shipped. "
